...
#
# Update: 2022-04-21-12-05-51
$AutoHarden_version="2022-04-21-12-05-51"
...
ask "Disable SNMP communication (can break printers)" "1.4-Firewall-BlockOutgoingSNMP.ask"
...
ask "Disable auto Windows Update during work time" "Optimiz-DisableAutoUpdate.ask"
ask "Disable WindowsDefender" "Optimiz-DisableDefender.ask"
...
if( ask "Disable SNMP communication (can break printers)" "1.4-Firewall-BlockOutgoingSNMP.ask" ){
fwRule @{
	Name='SNMP'
	Group='SNMP'
	Direction='Outbound'
...
Get-NetFirewallRule -DisplayName '*AutoHarden*SNMP*' | Remove-NetFirewallRule
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUdsmrsYWiHuaPF+bvje9IKzwD
# TcWgggo9MIIFGTCCAwGgAwIBAgIQlPiyIshB45hFPPzNKE4fTjANBgkqhkiG9w0B
...
# KoZIhvcNAQkEMRYEFKtdGqDZ85Cwr9nbBfJNg83UGSpPMA0GCSqGSIb3DQEBAQUA
# BIICAChXW3p1TVep2Ed+vfzLJx141CWfmIHrpfDlr1yFO8molDzyA80z9yvBaEYw
# wvrzHxIrBkUZtrr0G2OtEdOuB2fuqpYyAoo5/f6sCTFDzKRp25dEUezScbR1GP9a
# W8tZ7DzxBDEM7c4971vCwcjZRyBmWo8ZkB4XX4/arry95Z2OaSS/QdiH8PiZxblr
# Gh7UPSjYMQL0HJOCQz9kUze/AyFmFDfwnbARod/wIhiyR1v7VEJprazIn4syAP+y
# MFUa05qatpG/xDxEhPeDxjk5ft1/xyr2y1YcFkqG26TJBRu787KDBVKGoKqxTc01
# 6iRFt8hc/MfLJ8E28DJoeFcGaimF6xbIJsdPcslSl2OP92Yjnc7vEdrb2FgSgwtl
# GR4ApEeKVZ0txdWsUsj0JW3cumwqcMMv3zhXnRjGyRE13ZwxHCVlOo5d2njy3OFM
# tRoUSf06tyQpMxvqjYDKgUjRzgkskqsLhw7STBQf7ZTH97+0b3v97yIvkYm/XMYN
# nFv/2IrQ2mAw5yP6IB/RM4VvqcuKnS53LpW0DaFGQB0IG6H7owuqBSows2CI+K95
# 3/F9ynZas7uCo6NNhQosPOjv0bDZmm3uv4jphIyOeDeSJRU5oV+4z0TLHued0r6a
# x+IwBCHNm2YRH4ywRA5VlKqe2sQdRIweXi+qp3RM4xQVZo/v
